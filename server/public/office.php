...
try {
    ...
    $script='<script>window.CNCHOME_LIVE='.json_encode($boot,JSON_HEX_TAG|JSON_HEX_AMP|JSON_HEX_APOS|JSON_HEX_QUOT|JSON_THROW_ON_ERROR).';</script><script src="/session-context.js"></script>';
