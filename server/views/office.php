...
<?php foreach (['korea-regions.js','intake-codes.js','region-rules.js','admin-xlsx.js','admin-workspace.js','hr-workspace.js','grade-numbers.js','grade-calendar.js','grade-calendar-preview.js','policy-dates.js','policy-input.js','sales-workspace.js','office.js'] as $file): ?>
