...
async function main(){
 ...
 assert.equal(d.querySelectorAll('[data-grade-auto="monthly"]').length,0);assert.equal(q('[data-original-monthly] tbody').children.length,6);assert.match(q('[data-original-monthly]').textContent,/101~110건/);
