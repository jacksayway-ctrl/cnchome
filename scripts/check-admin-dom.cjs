...
async function main(){
 ...
 assert.equal(d.querySelectorAll('[data-grade-auto="monthly"]').length,0);assert.equal(q('[data-grade-period="monthly"][data-grade-index="1"][data-grade-field="min"]').value,'100');assert.equal(d.querySelectorAll('[data-grade-remove="monthly"]').length,6);
